...
pub enum DurabilityMode {
    /// SAFE: Wait for fsync before acknowledging (slower, no data loss)
    Safe,
    /// FAST: Acknowledge after WAL buffer write (faster, requires replication)
    Fast,
    /// ADAPTIVE: Choose based on batch size and system load
    Adaptive,
}
...
impl ServerConfig {
    ...
    pub fn low_latency() -> Self {
        Self {
            ...
            wal_sync_max_delay_micros: 500, // 0.5ms
            enable_metrics: true,
    ...
    pub fn high_throughput() -> Self {
        Self {
            ...
            wal_sync_max_delay_micros: 5000, // 5ms
            enable_metrics: true,
            metrics_report_interval_secs: 10,
        }
    }
    ...
    pub fn maximum_safety() -> Self {
        Self {
            ...
            wal_sync_max_delay_micros: 100, // 0.1ms
            enable_metrics: true,
            metrics_report_interval_secs: 10,
        }
    }
